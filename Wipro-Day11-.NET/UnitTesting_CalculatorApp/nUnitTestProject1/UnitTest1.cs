...
namespace nUnitTestProject1
{
    public class Tests
    {
        ...
        [Test]
        //[Explicit("This test is intentionally wrong - used only for demonstration")]
        public void WrongOutput_1_BasicMathMistake()
        {
            // This will FAIL (on purpose)
            Assert.AreEqual(5, 10 - 8);           // Expected 5, but 10-8 = 2
        }
